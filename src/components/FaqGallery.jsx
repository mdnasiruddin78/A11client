...
import image2 from '../assets/mark2.webp';
import image3 from '../assets/mark3.webp';
import image4 from '../assets/mark4.jpg';
import image5 from '../assets/mark5.jpg';
                ...
                <div className="space-y-2">
                    <div className="collapse collapse-plus bg-base-200">
                        ...
                        <div className="collapse-content">
                            <p>Yes. If the fillable form can be built using Adobe Acrobat®, it can be posted to WorkerServices. Here are some fillable form examples.</p>
                        </div>
                    </div>
                    <div className="collapse collapse-plus bg-base-200">
                        <input type="radio" name="my-accordion-3" />
                        <div className="collapse-title text-xl font-medium">can_third_party_forms_be_posted_to_workerservices?</div>
                        <div className="collapse-content">
                    ...
                    <div className="collapse collapse-plus bg-base-200">
                        <input type="radio" name="my-accordion-3" />
                        <div className="collapse-title text-xl font-medium">can_workerservices/ar_create_or_edit_forms_for_us?</div>
                        <div className="collapse-content">
